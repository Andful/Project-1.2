                                ...
                                addActionListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent e) {
                                        if(chooser.showOpenDialog(LevelEditor.this)==JFileChooser.APPROVE_OPTION);
                                        {
                                            ...
                                            if(directory!=null) {
                                                java.util.List<Vector3i> obstacles = new LinkedList<>();
                                                java.util.List<Vector3i> startconfig = new LinkedList<>();
                                                java.util.List<Vector3i> endconfig = new LinkedList<>();
                                                    ...
                                                    for (int j = 0; j < level[0].length; j++) {
                                                        for (int k = 0; k < level[0][0].length; k++) {
                                                            if (level[i][j][k] == OBSTACLE) {
                                                                obstacles.add(new Vector3i(i, j, k));
                                                            }
                                                            if (level[i][j][k] == START) {
                                                                startconfig.add(new Vector3i(i, j, k));
                                                            }
                                                            if (level[i][j][k] == END) {
                                                                endconfig.add(new Vector3i(i, j, k));
                                                            }
                                                        }
                                                    }
                                                }

                                                EnvironmentInt environmentInt = new EnvironmentInt(new Vector3i(x, y, z), obstacles, startconfig, endconfig);
                                                try {
